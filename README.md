...
- **LadderStar.com** — A live AI Interviewer and Jobs Board
- **Technomads.fun** — An AI Powered Minecraft Create Aeronautics server
...
**Backend & data** · Node · Firebase / Firestore · NumPy

**AI** · Anthropic · Gemini Live · multi-agent orchestration · agent tooling & skills
