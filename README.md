...
**🤖 AI-native systems** — multi-agent orchestration, live voice-to-voice AI interviewing, node-graph agent pipelines. I design around what these models are actually good at, and how I can push the boundary

**🎮 Games & mods** — NeoForge Java mods with physics integration, procedural generation, and persistence. Published on CurseForge and Modrinth.
...
**Frontend** · React · Next.js · Vite · Svelte · Preact · Tailwind · Framer Motion · Zustand · TanStack Query · React Router · React Flow · dnd kit · TipTap · Lucide
...
**Backend & infra** · Node · Express · FastAPI · Uvicorn · WebSockets · Firebase (Auth, Firestore, Storage, Functions, Admin, Rules) · Vercel (Queue, Analytics, Speed Insights) · Stripe · Resend · SSH2/SFTP · RCON · discord.js · OpenTelemetry · Docker

**Data & scientific** · NumPy · pandas · Pydantic · Zod · IndexedDB · ccxt
...
**Testing & tooling** · Vitest · Playwright · pytest · Testing Library · ESLint · Prettier · oxlint · GitHub Actions · Git
